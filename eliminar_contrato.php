<?php
	...
	// Eliminando los registros de la forma correspondiente.
	mysql_query("DELETE FROM Lease WHERE LeaseNumber = '$lNumber'") or die(mysql_error());  
	mysql_query("DELETE FROM Invoice WHERE leaseNumber = '$lNumber'") or die(mysql_error());
